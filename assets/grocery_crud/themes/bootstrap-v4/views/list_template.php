<?php
   ...
   //page js
    ...
    //$this->set_js_lib($this->default_theme_path.'/bootstrap-v4/datatables/jquery.js');
   // $this->set_js_lib($this->default_theme_path.'/bootstrap-v4/datatables/jquery.min.js');
    $this->set_js_lib($this->default_theme_path.'/bootstrap-v4/datatables/jquery.dataTables.js');
    $this->set_js_lib($this->default_theme_path.'/bootstrap-v4/datatables/dataTables.bootstrap4.js');
        ...
        ?></div>
 		...
 		<div class="row">
        	<div class="table-section">
                <div class="table-label" style="background: white; border: .01rem solid #cacbce; margin-bottom: 1%; border-radius: 7px;">
                        ...
                        ?>
                           <div class="floatR">
                                ...
                                <div class="floatR t5 l5">
                                    <a class="btn btn-success btn-md" href="<?php echo $add_url?>">
                ...
                <div class="table-container" style="border-top: 1px solid #DDD;">
                    ...
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        ...
                        <div class="scroll-if-required">
        			        <table id="na_datatable" class="table table-bordered grocery-crud-table table-hover">
        					<thead>
        						<tr>
