...
<head>
  ...
  <title>Discussion Form  | Registration Page</title>
  ...
  <style>
  body{
    background-image: linear-gradient(#64B5F6 25%,#42A5F5 75%)}
</style>
</head>
<body class="hold-transition register-page">
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>DFORUM</b>LTE</a>
  </div>
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <?php echo form_open('Auth/register', 'class="register-form" id="register-form"'); ?>
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control"  name="contact_no" placeholder="Phone Number">
          <div class="input-group-append">
            <div class="input-group-text">
